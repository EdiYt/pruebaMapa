...
public class RoutingExample {
    ...
    private void showRouteOnMap(Route route) {
        ...
        addCircleMapMarker(startPoint, R.drawable.punto);
        addCircleMapMarker(destination, R.drawable.punto);
                ...
                new CalculateRouteCallback() {
                    ...
                    public void onRouteCalculated(@Nullable RoutingError routingError, @Nullable List<Route> routes) {
                        if (routingError == null) {
                            ...
                            addCircleMapMarker(waypoint1.coordinates, R.drawable.punto);
                            addCircleMapMarker(waypoint2.coordinates, R.drawable.punto);
                        } else {
                            showDialog("Error while calculating a route:", routingError.toString());
                        }
                    }
